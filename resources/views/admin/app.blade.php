            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                   ...
                   @if(in_array(1 , Auth::user()->custom['admin_permission']))
                    ...
                    <li class="menu products">
                        <a href="/admin-panel/products/show?empty=0" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-inbox"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"></polyline><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path></svg>
                                <span style="font-size: 10px">{{ __('messages.empty_products') }}
                                    @if( Auth::user()->custom['ended_products_count'] > 0 )
                                    <span class="unreadcount" >
                                          <span class="insidecount" >
                                              <?=Auth::user()->custom['ended_products_count']?>
                                          </span>
                                    </span>
                                    @endif
                                 </span>
                    ...
                    <li class="menu transactions">
                        <a href="{{ route('transactions.index') }}" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-airplay"><path d="M5 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1"></path><polygon points="12 15 17 21 7 21 12 15"></polygon></svg>
                                <span>{{ __('messages.transations') }}</span>
                            </div>
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="menu warnings">
                        <a href="{{ route('warnings.index') }}" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-inbox"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"></polyline><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path></svg>
                                <span>{{ __('messages.warnings') }}
                                      @if( Auth::user()->custom['warning_count'] > 0 )
                                      <span class="unreadcount" >
                                            <span class="insidecount" >
                                                <?=Auth::user()->custom['warning_count']?>
                                            </span>
                                      </span>
                                      @endif
                                 </span>
